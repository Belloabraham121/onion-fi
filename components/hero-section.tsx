    ...
    <div className="relative overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800/50 border border-gray-700 mb-8">
          ...
          <span className="text-sm text-gray-300 uppercase tracking-wider">Welcome to OnionFi</span>
        </div>
        ...
        {/* CTA Button */}
        <Link href="/dashboard">
          <Button size="lg" className="bg-white text-black hover:bg-gray-100 px-8 py-3 text-lg font-medium mb-16">
            Launch App
          </Button>
        </Link>
